...
"""The number of beams allowed per satellite (synonymous to # of connections)"""
beamsPerSatellite = 32

"""The number of colors of beams per satellite"""
numColorsPerSatellite = 4

"""A list of the valid color IDs (e.g. A through D)"""
validColorIDs = [chr(ord('A') + i) for i in range(0, numColorsPerSatellite)]

"""
The maximum angle at which beams of the same color, on the same satellite, must not
be less than (e.g. angle of 8 degrees is invalid)
"""
starlinkInterferenceAngle = 10.0

"""
The maximum angle at which Starlink beams must not be within of external interference
(e.g. angle of 18 degrees between Starlink beam and external interference is invalid)
"""
externalInterferenceAngle = 20.0

"""
The maximum angle at which users can connect to a Starlink satellite.  This angle
